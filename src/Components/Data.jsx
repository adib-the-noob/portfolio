export const aboutMe={
     title: 'About Me',
     description: 'Hello, my name is Adib and I am a backend developer from Bangladesh with a passion for creating dynamic and efficient backend applications. I specialize in working with Django and the Django Rest Framework, and I am always eager to learn new technologies and improve my skills to deliver the best possible solutions for my clients. I am an experienced developer with a strong background in creating Backend applications that are both functional and visually appealing. Connect with me to know more about my skills and experience.'
}
...
export const hero={
     ...
     name: 'Mohammed',
     nickname: 'Adib',
     profession: 'Passionate Backend Developer',
     motto: 'My motto is,'
}